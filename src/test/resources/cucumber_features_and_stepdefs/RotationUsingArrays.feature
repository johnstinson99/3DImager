Feature: FloatColoredPVector rotations using arrays
  Background:
    Given a tolerance of 0.00001

   Scenario Outline: Test rotations using arrays
    Given a 3d point <intX>, <intY>, <intZ>
    When I rotate it using arrays by <rotateAngle> degrees around the <axis> axis
